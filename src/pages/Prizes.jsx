...
const PrizesSection = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white relative overflow-hidden py-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16 opacity-0 animate-fade-in-up">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter text-black leading-none mb-6">
            PRIZES
          </h1>
          
          <p className="text-lg md:text-xl text-gray-700 font-medium tracking-wide max-w-2xl mx-auto leading-relaxed">
              ...
              <div className="relative">
                ...
                <div
                  className={`
                    ...
                    ${index === 0 ? 'transform md:scale-110 md:-translate-y-8' : ''}
                ...
                >
                  ...
                  <div className="pt-8 text-center h-full flex flex-col justify-center">
                    <h3 className="text-xl md:text-2xl font-bold tracking-wider text-black uppercase mb-6">
                      {prize.position}
                    </h3>
                    
                    <div className="text-4xl md:text-5xl lg:text-6xl font-black text-black leading-none mb-4">
                      {prize.amount}
                    </div>
        ...
        <div className="text-center opacity-0 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
          <div className="inline-block relative">
            <div
              className="bg-black text-white px-12 py-6 shadow-2xl"
              style={{
                clipPath: 'polygon(5% 0, 95% 0, 100% 50%, 95% 100%, 5% 100%, 0% 50%)'
              }}
            >
              <div className="text-center">
                <div className="text-sm md:text-base font-bold tracking-wider uppercase mb-2">
                  Total Prize Pool
                </div>
