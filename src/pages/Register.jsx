...
const sendOtpEmail = async () => {
  ...
  try {
    const response = await fetch('https://profhack-backend.onrender.com/api/auth/send-otp', {
      method: 'POST',
      headers: {
...
const verifyOtp = async () => {
  ...
  try {
    const response = await fetch('https://profhack-backend.onrender.com/api/auth/verify-otp', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
const resendOtp = async () => {
  ...
  try {
    const response = await fetch('https://profhack-backend.onrender.com/api/auth/resend-otp', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://profhack-backend.onrender.com/api/auth/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
